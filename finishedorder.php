    ...
    <div class="content">
        <div class="container">
            <div class="bg-white" style="margin-bottom: 100px   ;margin-top: 100px;padding-bottom: 20px ;text-align: center; padding: 15px">
                ...
                <h4 style="margin-top: 20px; color:#000;">Cảm ơn bạn đã tin tưởng và lựa chọn <a href="./">LPHONE</a>, đơn hàng của bạn đã được tạo. Chúng tôi sẽ duyệt đơn hàng và giao hàng trong khoảng 3-7 ngày làm việc.</h4>
                <a href="./">
